  ...
  return (
    <section className='max-container'>
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>
            I've worked with Java-based web applications using the Spring Boot framework and leveling up my skills and teaming up with smart people. Here's the rundown:
          </p>
        </div>
